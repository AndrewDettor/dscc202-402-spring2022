...
# MAGIC %md
# MAGIC How did the new model do? It improved MAE to 49 from 51.
...
# MAGIC %md
# MAGIC Run result unavailable: job failed with error message Unexpected user error while creating the cluster for the job. Cause: PERMISSION_DENIED: You are not authorized to create clusters. Please contact your administrator
